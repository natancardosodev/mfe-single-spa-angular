export enum MensagensEnum {
    ...
    CPF_INEXISTENTE = 'Prezado usuário, não existe registro para o seu CPF.',
    ARQUIVO_LIVRO = 'Prezado usuário, favor anexar o arquivo referente ao livro digital.',
    PDF_INVALIDO = 'Prezado usuário, apenas arquivos no formato PDF são aceitos.',
    TAMANHO_ARQUIVO = 'Arquivo maior que o tamanho permitido: tamanho máximo 10MB'
}
