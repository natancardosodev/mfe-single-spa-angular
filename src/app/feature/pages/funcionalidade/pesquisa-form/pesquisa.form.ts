...
export class PesquisaForm extends FormGroup {
    ...
    constructor() {
        ...
        this.cnpj.setValidators([PesquisaForm.validaQuantidaDeDigito(14), PesquisaForm.validaCpfCnpj()]);

        this.nomeEmpresarial.setValidators([PesquisaForm.validaQuantidaDeDigito(3, true)]);

        this.cpfMembroQsa.setValidators([PesquisaForm.validaQuantidaDeDigito(11), PesquisaForm.validaCpfCnpj()]);

        this.numeroRegistro.setValidators([PesquisaForm.validaQuantidaDeDigito(11)]);
    ...
    private static validaQuantidaDeDigito(quantidade: number, nomeEmpresarial = false): ValidatorFn {
