import { CardOficioModule } from './../../../components/card-oficio/card-oficio.module';
import { NgModule } from '@angular/core';
import { CommonModule } from '@angular/common';
import { HttpClientModule } from '@angular/common/http';
import { CardsModule, FlapsModule } from 'lib-cards-genericos';

import { CardDocumentosModule } from './../../../components/card-documentos/card-documentos.module';
